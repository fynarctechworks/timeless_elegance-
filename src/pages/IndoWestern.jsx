...
function IndoWestern() {
  ...
  const products = [
    {
      id: 1,
      name: "Contemporary Anarkali Gown",
      category: "Champagne Gold Sequin",
      price: "₹45,000",
    ...
    {
      id: 2,
      name: "Floral Cape Jacket Set",
      category: "Mint Green with Embroidery",
      price: "₹38,500",
      image: softPinkFloral,
      secondaryImage: coralPinkBandhani,
      badge: "New"
    },
    {
      id: 3,
      name: "Modern Sharara Set",
      category: "Coral Pink with Mirror Work",
      price: "₹42,000",
    ...
    },
    {
      ...
      category: "Emerald Green Fusion",
      price: "₹52,000",
      image: emeraldBanarasi,
      secondaryImage: burgundyChanderi,
      badge: "Bestseller",
      badgePosition: "right"
    },
    {
      ...
      category: "Burgundy with Gold Details",
      price: "₹35,000",
    ...
    {
      id: 6,
      name: "Velvet Gown with Train",
      category: "Mauve Evening Wear",
      price: "₹68,000",
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-20 w-full">
              <div className="max-w-2xl text-white space-y-3 sm:space-y-4">
                <nav className="flex items-center gap-2 text-[#c5a059] text-[10px] sm:text-xs font-bold uppercase tracking-widest mb-4 sm:mb-6">
                  ...
                  <span className="text-gray-200">Indo-Western</span>
                </nav>
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif font-bold leading-tight">Indo-Western Fusion</h1>
                <p className="text-white/80 text-sm sm:text-base md:text-lg lg:text-xl font-light italic max-w-xl">
                  Where tradition meets modernity. Contemporary designs that celebrate the best of both worlds.
                </p>
              </div>
            </div>
          </div>
            ...
            <aside className={`w-full lg:w-64 flex-shrink-0 space-y-8 lg:space-y-10 ${mobileFiltersOpen ? 'block' : 'hidden lg:block'}`}>
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <button className="group flex items-center gap-2 w-full text-sm cursor-pointer">
                    <span className="size-4 bg-[#98D8C8] border border-black/10 rounded-full"></span>
                    <span className="group-hover:text-[#8B1538] transition-colors">Mint Green</span>
                  ...
                  <button className="group flex items-center gap-2 w-full text-sm cursor-pointer">
                    ...
                    <span className="ml-auto text-xs text-gray-400">(13)</span>
                  </button>
                  <button className="group flex items-center gap-2 w-full text-sm cursor-pointer">
                    ...
                    <span className="ml-auto text-xs text-gray-400">(07)</span>
                  </button>
                  <button className="group flex items-center gap-2 w-full text-sm cursor-pointer">
                    <span className="size-4 bg-[#800020] border border-black/10 rounded-full"></span>
                    <span className="group-hover:text-[#8B1538] transition-colors">Wine</span>
                    <span className="ml-auto text-xs text-gray-400">(05)</span>
                  </button>
                </div>
              </div>
              ...
              {/* Style Filter */}
              <div className="space-y-6">
                <h3 className="text-sm font-bold uppercase tracking-widest border-b border-[#c5a059]/30 pb-4" style={{ color: '#2d1618' }}>Style</h3>
                <div className="space-y-4">
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <input className="rounded border-gray-300 size-4 cursor-pointer" type="checkbox" style={{ accentColor: '#c5a059' }} />
                    <span className="text-sm group-hover:text-[#8B1538] transition-colors">Gown</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <input className="rounded border-gray-300 size-4 cursor-pointer" type="checkbox" style={{ accentColor: '#c5a059' }} />
                    <span className="text-sm group-hover:text-[#8B1538] transition-colors">Jacket Set</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <input className="rounded border-gray-300 size-4 cursor-pointer" type="checkbox" style={{ accentColor: '#c5a059' }} />
                    <span className="text-sm group-hover:text-[#8B1538] transition-colors">Sharara</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <input className="rounded border-gray-300 size-4 cursor-pointer" type="checkbox" style={{ accentColor: '#c5a059' }} />
                    <span className="text-sm group-hover:text-[#8B1538] transition-colors">Palazzo Suit</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <input className="rounded border-gray-300 size-4 cursor-pointer" type="checkbox" style={{ accentColor: '#c5a059' }} />
                    <span className="text-sm group-hover:text-[#8B1538] transition-colors">Cape Style</span>
                  </label>
                </div>
              </div>
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 mb-6 sm:mb-8 lg:mb-10">
                <p className="text-xs sm:text-sm text-gray-500">
                  Showing <span className="font-bold" style={{ color: '#c5a059' }}>64</span> Indo-Western Pieces
                </p>
