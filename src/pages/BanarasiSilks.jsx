...
function BanarasiSilks() {
  ...
  const products = [
    {
      id: 1,
      name: "Vintage Gold Buta Banarasi",
    ...
    {
      id: 2,
      name: "Emerald Bloom Jangla",
      category: "Banarasi Georgette",
      price: "₹1,04,000",
    ...
    {
      id: 5,
      name: "Champagne Gold Tissue",
      category: "Hand-woven Tissue Silk",
      price: "₹1,21,000",
    ...
    {
      id: 6,
      name: "Antique Bronze Weave",
      category: "Matka Banarasi Silk",
      price: "₹74,000",
      ...
      <main className="w-full">
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-20 w-full">
              <div className="max-w-2xl text-white space-y-3 sm:space-y-4">
                <nav className="flex items-center gap-2 text-[#c5a059] text-[10px] sm:text-xs font-bold uppercase tracking-widest mb-4 sm:mb-6">
                  ...
                  <span className="text-gray-200">Banarasi Silks</span>
                </nav>
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif font-bold leading-tight">Banarasi Silks</h1>
                <p className="text-white/80 text-sm sm:text-base md:text-lg lg:text-xl font-light italic max-w-xl">
                  From the sacred looms of Kashi, discover the world's most intricate gold and silver zari weaves. A legacy of royalty and timeless devotion.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-20 py-8 sm:py-12 lg:py-20">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <aside className={`w-full lg:w-64 flex-shrink-0 space-y-8 lg:space-y-10 ${mobileFiltersOpen ? 'block' : 'hidden lg:block'}`}>
              ...
              {/* Zari Type Filter */}
              <div className="space-y-6">
                <h3 className="text-sm font-bold uppercase tracking-widest border-b border-[#c5a059]/30 pb-4" style={{ color: '#c5a059' }}>Zari Type</h3>
                <div className="space-y-4">
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <input className="rounded border-gray-300 size-4 cursor-pointer" type="checkbox" style={{ accentColor: '#c5a059' }} />
                    <span className="text-sm group-hover:text-[#8B1538] transition-colors">Pure Gold Zari</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <input className="rounded border-gray-300 size-4 cursor-pointer" type="checkbox" style={{ accentColor: '#c5a059' }} />
                    <span className="text-sm group-hover:text-[#8B1538] transition-colors">Antique Silver Zari</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <input className="rounded border-gray-300 size-4 cursor-pointer" type="checkbox" style={{ accentColor: '#c5a059' }} />
                    <span className="text-sm group-hover:text-[#8B1538] transition-colors">Copper Toned Zari</span>
                  </label>
                </div>
              </div>
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 mb-6 sm:mb-8 lg:mb-10">
                <p className="text-xs sm:text-sm text-gray-500">
                  Showing <span className="font-bold" style={{ color: '#c5a059' }}>24</span> Banarasi Silks
                </p>
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-20 text-center relative overflow-hidden" style={{ backgroundColor: '#221013' }}>
          ...
          <div className="relative z-10 max-w-4xl mx-auto space-y-6 sm:space-y-8">
            <span className="text-[#c5a059] uppercase tracking-[0.3em] sm:tracking-[0.5em] text-[10px] sm:text-xs font-bold">The Heritage of Kashi</span>
            <h2 className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold italic leading-tight">Every Thread a Sacred Story</h2>
            <p className="text-white/80 text-sm sm:text-base md:text-lg lg:text-xl font-light leading-relaxed">
              Our Banarasi silks are crafted by 5th generation master weavers who still use traditional wooden pit looms. A single saree can take up to 600 hours of painstaking precision to complete.
            </p>
