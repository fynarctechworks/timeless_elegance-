...
function HeritageWeaves() {
  ...
  const products = [
    ...
    {
      id: 2,
      name: "Chanderi Silk Heritage",
      category: "Authentic Chanderi",
      price: "₹98,000",
    ...
    },
    {
      ...
      category: "Traditional Maheshwari",
      price: "₹65,000",
    ...
    {
      id: 6,
      name: "Baluchari Heritage Silk",
      category: "Authentic Baluchari",
      price: "₹1,15,000",
    ...
    <>
      ...
      <main className="w-full">
        ...
        <section className="relative h-[50vh] sm:h-[55vh] lg:h-[60vh] min-h-[350px] sm:min-h-[400px] lg:min-h-[450px] overflow-hidden">
          <img 
            alt="Heritage Weaves Collection" 
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-20 w-full">
              <div className="max-w-2xl text-white space-y-3 sm:space-y-4">
                <nav className="flex items-center gap-2 text-[#c5a059] text-[10px] sm:text-xs font-bold uppercase tracking-widest mb-4 sm:mb-6">
                  ...
                  <span className="text-gray-200">Heritage Weaves</span>
                </nav>
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-serif font-bold leading-tight">Heritage Weaves</h1>
                <p className="text-white/80 text-sm sm:text-base md:text-lg lg:text-xl font-light italic max-w-xl">
                  Preserving centuries of artisanal legacy. Each weave tells the story of India's rich textile heritage passed down through generations.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <aside className={`w-full lg:w-64 flex-shrink-0 space-y-8 lg:space-y-10 ${mobileFiltersOpen ? 'block' : 'hidden lg:block'}`}>
              ...
              <div className="space-y-6">
                <h3 className="text-sm font-bold uppercase tracking-widest border-b border-[#c5a059]/30 pb-4" style={{ color: '#c5a059' }}>Weave Type</h3>
                <div className="flex flex-col gap-3">
                  <button className="group flex items-center gap-2 w-full text-sm cursor-pointer">
                    <span className="group-hover:text-[#8B1538] transition-colors">Kanjivaram</span>
                    <span className="ml-auto text-xs text-gray-400">(28)</span>
                  </button>
                  <button className="group flex items-center gap-2 w-full text-sm cursor-pointer">
                    <span className="group-hover:text-[#8B1538] transition-colors">Banarasi</span>
                    <span className="ml-auto text-xs text-gray-400">(24)</span>
                  </button>
                  <button className="group flex items-center gap-2 w-full text-sm cursor-pointer">
                    <span className="group-hover:text-[#8B1538] transition-colors">Patola</span>
                    <span className="ml-auto text-xs text-gray-400">(12)</span>
                  </button>
                  <button className="group flex items-center gap-2 w-full text-sm cursor-pointer">
                    <span className="group-hover:text-[#8B1538] transition-colors">Chanderi</span>
                    <span className="ml-auto text-xs text-gray-400">(18)</span>
                  </button>
                  <button className="group flex items-center gap-2 w-full text-sm cursor-pointer">
                    <span className="group-hover:text-[#8B1538] transition-colors">Maheshwari</span>
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col gap-3">
                  <button className="group flex items-center gap-2 w-full text-sm cursor-pointer">
                    ...
                    <span className="group-hover:text-[#8B1538] transition-colors">Rich Red</span>
                  ...
                  <button className="group flex items-center gap-2 w-full text-sm cursor-pointer">
                    ...
                    <span className="group-hover:text-[#8B1538] transition-colors">Emerald</span>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <label className="flex items-center gap-3 cursor-pointer group">
                    ...
                    <span className="text-sm group-hover:text-[#8B1538] transition-colors">Pure Silk</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <input className="rounded border-gray-300 size-4 cursor-pointer" type="checkbox" style={{ accentColor: '#c5a059' }} />
                    <span className="text-sm group-hover:text-[#8B1538] transition-colors">Cotton Silk</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer group">
                    <input className="rounded border-gray-300 size-4 cursor-pointer" type="checkbox" style={{ accentColor: '#c5a059' }} />
                    <span className="text-sm group-hover:text-[#8B1538] transition-colors">Tussar Silk</span>
                  </label>
                </div>
              </div>
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4 mb-6 sm:mb-8 lg:mb-10">
                <p className="text-xs sm:text-sm text-gray-500">
                  Showing <span className="font-bold" style={{ color: '#c5a059' }}>48</span> Heritage Weaves
                </p>
                ...
                {products.map((product) => (
                  <div key={product.id} className="group silk-texture border border-[#e5e1d5] bg-white">
                    <div className="relative aspect-[3/4] overflow-hidden cursor-pointer" onClick={() => navigate('/product-details', { state: { product } })}>
                      ...
                      />
                      {product.badge && (
                        <div className={`absolute top-3 left-3 sm:top-4 sm:left-4 text-white text-[9px] sm:text-[10px] font-bold uppercase px-2 sm:px-3 py-1 tracking-widest ${product.badge === 'Heritage Edit' ? 'bg-[#8B1538]' : 'bg-[#c5a059]'}`}>
                          {product.badge}
                        </div>
                      )}
                      <button 
                    ...
                    <div className="p-4 sm:p-5 lg:p-6 text-center space-y-1.5 sm:space-y-2">
                      ...
                      <div className="pt-3 sm:pt-4 flex gap-2">
                        <button onClick={(e) => { e.stopPropagation(); addToCart({ ...product, quantity: 1 }); }} className="flex-1 text-white py-2.5 sm:py-3 text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.15em] sm:tracking-[0.2em] hover:bg-[#c5a059] transition-colors cursor-pointer" style={{ backgroundColor: '#2d1618' }}>
                          Add to Bag
                        </button>
                      </div>
                    </div>
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-20 text-center relative overflow-hidden" style={{ backgroundColor: '#221013' }}>
          ...
          <div className="relative z-10 max-w-4xl mx-auto space-y-6 sm:space-y-8">
            <span className="text-[#c5a059] uppercase tracking-[0.3em] sm:tracking-[0.5em] text-[10px] sm:text-xs font-bold">Artisanal Legacy</span>
            <h2 className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-bold italic leading-tight">Weaving India's Rich Heritage</h2>
            <p className="text-white/80 text-sm sm:text-base md:text-lg lg:text-xl font-light leading-relaxed">
              Our heritage weaves collection celebrates India's timeless textile traditions. From the looms of Kanchipuram to the pit looms of Varanasi, each piece carries the soul of centuries-old craftsmanship preserved by master weavers.
            </p>
            <div className="w-12 sm:w-16 h-1 bg-[#c5a059] mx-auto"></div>
          </div>
        </section>
      </main>
